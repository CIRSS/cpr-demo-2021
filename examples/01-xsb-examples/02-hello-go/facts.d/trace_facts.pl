...
%---------------------------------------------------------------------------------------------------
cpr_execution(e1, r0, p1, '/mnt/cpr-demo-2021/examples/01-xsb-examples/02-hello-go/./run.sh', '/mnt/cpr-demo-2021/examples/01-xsb-examples/02-hello-go', nil).
cpr_execution(e2, r0, p2, '/mnt/cpr-demo-2021/examples/01-xsb-examples/02-hello-go/./bin/hello_go', '/mnt/cpr-demo-2021/examples/01-xsb-examples/02-hello-go', nil).
...
%---------------------------------------------------------------------------------------------------
cpr_file_open(o20, r0, p2, '/mnt/cpr-demo-2021/examples/01-xsb-examples/02-hello-go', 4, true, nil).
cpr_file_open(o21, r0, p2, '/mnt/cpr-demo-2021/examples/01-xsb-examples/02-hello-go/bin/hello_go', 1, false, nil).
cpr_file_open(o22, r0, p2, '/sys/kernel/mm/transparent_hugepage/hpage_pmd_size', 1, false, nil).
cpr_file_open(o23, r0, p3, '/mnt/cpr-demo-2021/examples/01-xsb-examples/02-hello-go', 4, true, nil).
cpr_file_open(o24, r0, p4, '/mnt/cpr-demo-2021/examples/01-xsb-examples/02-hello-go', 4, true, nil).
cpr_file_open(o25, r0, p5, '/mnt/cpr-demo-2021/examples/01-xsb-examples/02-hello-go', 4, true, nil).
cpr_file_open(o26, r0, p6, '/mnt/cpr-demo-2021/examples/01-xsb-examples/02-hello-go', 4, true, nil).
