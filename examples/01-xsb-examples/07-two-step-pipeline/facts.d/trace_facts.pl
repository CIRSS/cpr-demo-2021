...
cpr_execution(e2, r0, p2, '/usr/bin/cat', '/mnt/cpr-demo-2021/examples/01-xsb-examples/07-two-step-pipeline', nil).
cpr_execution(e3, r0, p3, '/usr/bin/cat', '/mnt/cpr-demo-2021/examples/01-xsb-examples/07-two-step-pipeline', nil).
...
cpr_file_open(o37, r0, p2, '/mnt/cpr-demo-2021/examples/01-xsb-examples/07-two-step-pipeline/inputs/file1.txt', 1, false, nil).
cpr_file_open(o43, r0, p3, '/mnt/cpr-demo-2021/examples/01-xsb-examples/07-two-step-pipeline', 4, true, nil).
cpr_file_open(o44, r0, p3, '/mnt/cpr-demo-2021/examples/01-xsb-examples/07-two-step-pipeline/outputs/file3.txt', 2, false, nil).
...
cpr_file_open(o49, r0, p3, '/mnt/cpr-demo-2021/examples/01-xsb-examples/07-two-step-pipeline/temp/file2.txt', 1, false, nil).
